...
const CrawlResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'headers', '3': 8, '4': 3, '5': 11, '6': '.starbelly.CrawlResponse.HeadersEntry'},
...
const Job$json = const {
  ...
  '2': const [
    ...
    const {'1': 'run_state', '3': 5, '4': 1, '5': 14, '6': '.starbelly.JobRunState'},
    const {'1': 'started_at', '3': 6, '4': 1, '5': 9},
    const {'1': 'completed_at', '3': 7, '4': 1, '5': 9},
    const {'1': 'item_count', '3': 8, '4': 1, '5': 5, '7': '-1'},
    const {'1': 'http_success_count', '3': 9, '4': 1, '5': 5, '7': '-1'},
    const {'1': 'http_error_count', '3': 10, '4': 1, '5': 5, '7': '-1'},
    const {'1': 'exception_count', '3': 11, '4': 1, '5': 5, '7': '-1'},
    const {'1': 'http_status_counts', '3': 12, '4': 3, '5': 11, '6': '.starbelly.Job.HttpStatusCountsEntry'},
  ],
