...
const Request$json = const {
  ...
  '2': const [
    ...
    const {'1': 'set_job_status', '3': 3, '4': 1, '5': 11, '6': '.starbelly.RequestSetJobStatus'},
...
const RequestSetJobStatus$json = const {
  '1': 'RequestSetJobStatus',
  '2': const [
    const {'1': 'job_id', '3': 1, '4': 2, '5': 12},
    const {'1': 'action', '3': 2, '4': 2, '5': 14, '6': '.starbelly.RequestSetJobStatus.Action'},
  ],
  '4': const [RequestSetJobStatus_Action$json],
};

const RequestSetJobStatus_Action$json = const {
  '1': 'Action',
  '2': const [
    const {'1': 'CANCEL', '2': 1},
    const {'1': 'PAUSE', '2': 2},
