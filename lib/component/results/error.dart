...
///
/// TODO This is very similar to the success and exception views. I can't think
...
class ResultsErrorView implements AfterViewInit {
    int currentPage = 1;
    int endRow = 0;
    ...
    /// Constructor
    ResultsErrorView(this._document, this._jobStatus, this._routeParams,
        this._server) {
